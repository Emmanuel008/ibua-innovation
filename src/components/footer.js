  ...
  <div className="container">
    <div className="row">
      <div className="col-lg-3 col-10 me-auto mb-4">
        <h4 className="text-white mb-3"><a href="index.html">iBUA</a> Hub</h4>
        <p className="copyright-text text-muted mt-lg-5 mb-4 mb-lg-0">Copyright © 2024 <strong>iBUA Hub</strong></p>
        <br />
        <p className="copyright-text"> <a href="https://www.tooplate.com/" target="_blank" /></p>
      </div>
      <div className="col-lg-5 col-8">
        <h5 className="text-white mb-3">Sitemap</h5>
        <ul className="footer-menu d-flex flex-wrap">
          <li className="footer-menu-item"><a href="about.html" className="footer-menu-link">About</a></li>
          <li className="footer-menu-item"><a href="Updates.html" className="footer-menu-link">Update</a></li>
